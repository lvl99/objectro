...
function transform(input) {
  ...
  props.forEach(function (processProps) {
    ...
    if (Object(lodash["isString"])(processProps)) {
      output[processProps] = !Object(lodash["isNil"])(input[processProps]) ? input[processProps] : output[processProps];
    } // An object represents a map from the input structure to a new structure
    else if (Object(lodash["isPlainObject"])(processProps)) {
        Object.keys(processProps).forEach(function (propName) {
          ...
          if (Object(lodash["isFunction"])(outputProp)) {
            ...
            var outputValue = outputProp.call(immutableInput, inputValue, propName, output); // If a function doesn't return anything, then we assume the function
            // has done the necessary manipulations to the output object itself

            if (outputValue !== undefined) {
              if (Object(lodash["isPlainObject"])(outputValue)) {
          ...
          else if (Object(lodash["isPlainObject"])(inputValue) && (Object(lodash["isPlainObject"])(outputProp) || Object(lodash["isArray"])(outputProp))) {
              output[propName] = transform.apply(void 0, [inputValue].concat(_toConsumableArray(Object(lodash["castArray"])(outputProp))));
            } // Map input value to new prop in output
            else if (Object(lodash["isString"])(outputProp)) {
                output[outputProp] = !Object(lodash["isNil"])(inputValue) ? inputValue : output[outputProp];
              }
        });
      }
  });
...
var util_has = function has(input, propName, expectedValue) {
  return expectedValue === undefined ? Object(lodash["has"])(input, propName) : Object(lodash["has"])(input, propName) && (Object(lodash["isFunction"])(expectedValue) ? !!expectedValue.call(undefined, Object(lodash["get"])(input, propName)) : Object(lodash["get"])(input, propName) === expectedValue);
};
...
var util_isFloat = function isFloat(input) {
  return !Object(lodash["isNaN"])(input) && Object(lodash["isNumber"])(input) && !Object(lodash["isInteger"])(input) && input !== Infinity;
};
/**
...
var CHECK_TYPE = {
  ...
  arrayLike: lodash["isArrayLike"],
  map: lodash["isMap"],
  set: lodash["isSet"],
  object: lodash["isObject"],
  objectLike: lodash["isObjectLike"],
  plainObject: lodash["isPlainObject"],
  ...
  nan: lodash["isNaN"],
  nil: lodash["isNil"],
  error: lodash["isError"],
  native: lodash["isNative"],
  truthy: isTruthy,
  falsy: isFalsy
};
/**
...
var validationRules = {
  ...
  _startsWith: function _startsWith(input, value) {
    var _reStartsWith = new RegExp("^".concat(Object(lodash["escapeRegExp"])(value)));
  ...
  _type: function _type(input, type) {
    return util_has(CHECK_TYPE, type, lodash["isFunction"]) && CHECK_TYPE[type].call(input, input);
  },
  ...
  _has: function _has(input, props, options) {
    ...
    if (Object(lodash["isArray"])(props)) {
  ...
  _hasProps: function _hasProps(input, values, options) {
    ...
    if (Object(lodash["isString"])(values) || Object(lodash["isArray"])(values)) {
      return validate(input, {
        _has: values
      });
    } // Check if has props with specific values
    else if (Object(lodash["isObject"])(values)) {
        var isValid = false;
        ...
        for (var propName in values) {
          ...
          var checkInput = Object(lodash["isArray"])(input) || util_has(input, propName) ? input[propName] : util_has(options, ["data", propName]) ? options.data[propName] : undefined;

          if (checkInput !== undefined) {
            var arrayCheckInput = Object(lodash["castArray"])(checkInput);
            var checkEachValue = Object(lodash["castArray"])(values[propName]); // Match if all values are within
...
function validate(input, rules, options) {
  ...
  var _options = generateOptions(validate_objectSpread({}, options, {
    _depth: util_has(options, "_depth", lodash["isInteger"]) ? options._depth : 0
  }));
